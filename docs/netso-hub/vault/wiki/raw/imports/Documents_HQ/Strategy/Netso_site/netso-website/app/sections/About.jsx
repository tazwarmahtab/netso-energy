  ...
  return (
    ...
    >
      ...
      <div className="mt-16 text-center max-w-3xl mx-auto px-6">
        ...
        >
          We&apos;re pioneering the future of solar energy in Bangladesh with innovative
          rooftop solutions that combine cutting-edge technology with beautiful design.
          Our mission is to make sustainable energy accessible to every building.
        </p>
      </div>
    </section>
  );
