  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-6xl mx-auto h-[450px] md:h-[600px] xl:h-[700px] rounded-3xl overflow-hidden shadow-2xl">
        <Image
          ref={img}
          src="/assets/Recentinstallations.png"
          alt="Recent Installations"
          fill
      ...
      <div className="mt-16 text-center max-w-3xl mx-auto px-6">
        ...
        >
          From Gulshan rooftops to commercial complexes across Dhaka — Netso
          installations are already changing the way Bangladesh goes solar.
        </p>
      </div>
    </section>
  );
