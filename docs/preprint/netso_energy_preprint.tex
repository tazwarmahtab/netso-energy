...
\end{equation}
where $Q_{\text{grid}} = 118{,}000\text{ kWh/yr}$, $C_{\text{grid}} = \text{BDT } 1{,}748{,}056\text{/yr}$, and $F_{\text{demand}} = \text{BDT } 216{,}000\text{/yr}$. The true variable rate $R_{\text{var}}$ is:
\begin{equation}
R_{\text{var}}
  = \frac{C_{\text{grid}} - F_{\text{demand}}}{Q_{\text{grid}}}
  = \frac{1{,}748{,}056 - 216{,}000}{118{,}000}
  = \text{BDT } 12.98\text{/kWh}
\label{eq:true_var}
\end{equation}
...
\begin{itemize}
    \item \textbf{Scenario A (Baseline):} $K_A = \text{BDT } 55{,}000\text{/kW}$, EPC hard cost of BDT~40,000/kW plus developer margin of BDT~15,000/kW. Total CAPEX: $I_A = \text{BDT } 4{,}400{,}000$ \cite{gt_constants}.
    \item \textbf{Scenario B (Policy Upside):} The FY2026--27 National Budget eliminates import duties on PV modules, inverters, and racking. $K_B = \text{BDT } 40{,}000\text{/kW}$ ($I_B = \text{BDT } 3{,}200{,}000$) \cite{gt_constants}.
\end{itemize}
