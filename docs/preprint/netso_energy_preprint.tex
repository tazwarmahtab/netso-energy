...
\begin{enumerate}
    \item \textbf{Conditions Precedent:} Execution requires grid sanction load verification ($\ge 115\text{ kW}$ under BPDB's 70\% net-metering capacity ceiling) and Chattogram Development Authority (CDA) rooftop structural engineering certification \cite{rsa_doc}.
