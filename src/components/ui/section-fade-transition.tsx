...
export function SectionFadeTransition({
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_-10%,rgba(200,178,255,0.14),transparent_52%),linear-gradient(to_bottom,rgba(10,9,6,0.9)_0%,rgba(10,9,6,0.35)_38%,rgba(244,237,227,0.94)_72%,rgba(244,237,227,1))]" />
