...
const en: SiteCopy = {
  ...
  hero: {
    ...
    body:
      "NETSO designs and installs solar pergolas that transform unused rooftops into beautiful, productive energy infrastructure.",
  ...
  projects: {
    ...
    cards: [
      ...
      },
      {
        ...
        system: "Solar canopy concept",
        type: "Residential",
      },
      {
        title: "Family home rooftop",
        location: "Uttara, Dhaka",
        system: "Assessment-led rooftop solar scope",
        type: "Residential",
      },
      {
        title: "Dense urban rooftop",
        location: "Old Dhaka",
        system: "Context-specific rooftop review",
        type: "Residential",
      },
    ],
...
const bn: SiteCopy = {
  ...
  hero: {
    ...
    body:
      "NETSO সৌর পারগোলা ডিজাইন ও ইনস্টল করে, যা অব্যবহৃত ছাদকে সুন্দর ও উৎপাদনশীল জ্বালানি অবকাঠামোয় রূপান্তর করে।",
  ...
  projects: {
    ...
    cards: [
      ...
      },
      {
        title: "টাউনহাউস ছাদ",
        location: "বনানী, ঢাকা",
        system: "সোলার ক্যানপি কনসেপ্ট",
        type: "Residential",
      },
      {
        title: "পারিবারিক বাড়ির ছাদ",
        location: "উত্তরা, ঢাকা",
        system: "অ্যাসেসমেন্ট-নির্ভর রুফটপ সোলার স্কোপ",
        type: "Residential",
      },
      {
        title: "ঘন নগর ছাদ",
        location: "পুরান ঢাকা",
        system: "প্রেক্ষাপট-নির্দিষ্ট রুফটপ রিভিউ",
        type: "Residential",
      },
    ],
